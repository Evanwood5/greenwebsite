      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <FadeIn className="text-center mb-16">
            ...
            <p className="text-[15px] leading-relaxed max-w-lg mx-auto mb-10" style={{ color: '#a1a1aa' }}>
          ...
          <div className="grid md:grid-cols-2 gap-6 items-stretch">
            ...
            >
              ...
              <div className="flex justify-between items-start mb-8 relative z-10">
                <div
                  ...
                  style={{ background: 'rgba(88,101,242,0.1)', border: '1px solid rgba(88,101,242,0.2)', boxShadow: '0 0 20px rgba(88,101,242,0.2)' }}
                >
                ...
                <div
                  ...
                  style={{ color: '#8b96ff', background: 'rgba(88,101,242,0.1)', border: '1px solid rgba(88,101,242,0.2)', letterSpacing: '0.05em' }}
                >
              ...
              <h3 className="text-xl font-bold text-white mb-3 relative z-10" style={{ letterSpacing: '-0.01em' }}>Community Support</h3>
              <p className="text-[14px] leading-relaxed mb-8 relative z-10" style={{ color: '#8e8e93' }}>
            ...
            >
              ...
              <div className="flex justify-between items-start mb-8 relative z-10">
                <div
                  className="w-12 h-12 rounded-full flex items-center justify-center"
                  style={{ background: 'rgba(249,115,22,0.1)', border: '1px solid rgba(249,115,22,0.2)', boxShadow: '0 0 20px rgba(249,115,22,0.2)' }}
                >
                ...
                <div
                  className="inline-flex items-center gap-1.5 text-[9px] font-bold px-3 py-1.5 rounded-full"
                  style={{ color: '#F97316', background: 'rgba(249,115,22,0.1)', border: '1px solid rgba(249,115,22,0.2)', letterSpacing: '0.05em' }}
                >
              ...
              <h3 className="text-xl font-bold text-white mb-3 relative z-10" style={{ letterSpacing: '-0.01em' }}>University Partnerships</h3>
              <p className="text-[14px] leading-relaxed mb-8 relative z-10" style={{ color: '#8e8e93' }}>
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-5 py-2.5 text-[14px] font-medium text-white rounded-xl transition-all duration-200 cursor-pointer relative z-10 w-fit"
