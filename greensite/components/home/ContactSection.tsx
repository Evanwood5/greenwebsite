...
export default function ContactSection() {
  return (
    <section id="contact" style={{ background: '#f0ece4', borderTop: '1px solid rgba(30,58,30,0.08)' }} className="px-6 py-24">
          ...
          <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x" style={{ borderColor: 'rgba(30,58,30,0.12)', border: '1px solid rgba(30,58,30,0.12)', borderRadius: '16px', overflow: 'hidden' }}>
            ...
            <div className="p-10 flex flex-col" style={{ background: '#ffffff' }}>
              <div className="mb-6">
                ...
                <h3 className="text-2xl font-bold mb-3" style={{ color: '#1a2e1a', letterSpacing: '-0.02em' }}>Partner with us</h3>
            ...
            <div className="p-10 flex flex-col" style={{ background: '#ffffff' }}>
              <div className="mb-6">
                ...
                <h3 className="text-2xl font-bold mb-3" style={{ color: '#1a2e1a', letterSpacing: '-0.02em' }}>Join our Discord</h3>
                <p className="text-[14px] leading-relaxed" style={{ color: '#5a7a5a' }}>
