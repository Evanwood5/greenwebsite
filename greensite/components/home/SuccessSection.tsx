...
const stories = [
  { name: 'Adiva J', company: 'GreenStone FCS',        avatar: '/addy.png'    },
...
export default function SuccessSection() {
  ...
  return (
    <section className="px-6 py-16 lg:py-20" style={{ background: '#0f2510' }}>
                  ...
                  <SwiperSlide key={s.name}>
                    <div className="flex flex-col">
                      <div className="overflow-hidden rounded-lg" style={{ aspectRatio: '1/1' }}>
                        <img src={s.avatar} alt={s.name} className="w-full h-full object-cover object-top" />
                      </div>
