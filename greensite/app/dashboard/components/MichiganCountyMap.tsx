      ...
      <div style={{ display: "flex", gap: 24, height: "calc(100% - 40px)" }}>
        ...
        <div style={{ flex: "0 0 60%", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
            <div style={{ fontSize: 14, color: "#888", fontWeight: 600 }}>Job Density by County</div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: "#888" }}>
              ...
              <div style={{ display: "flex", gap: 3 }}>
                {["#3b82f6", "#60a5fa", "#93c5fd", "#bfdbfe", "#dbeafe"].map((color, i) => (
                  <div key={i} style={{ width: 40, height: 20, background: color, border: "1px solid #333", borderRadius: 4 }} />
                ))}
              </div>
              <span>More Jobs</span>
            </div>
            ...
            <div style={{ marginTop: 20, width: "80%" }}>
              <div style={{ fontSize: 12, color: "#888", marginBottom: 12, fontWeight: 600 }}>Top Counties</div>
