...
export default function CustomJobsPage() {
    ...
    const loadMatchedJobs = async () => {
        ...
        try {
            ...
            if (jobsError) {
                ...
                console.error('Jobs error message:', jobsError?.message);
                console.error('Jobs error details:', jobsError?.details);
                console.error('Jobs error hint:', jobsError?.hint);
                console.error('Jobs error code:', jobsError?.code);
    ...
    const removeResume = async () => {
        ...
        try {
            ...
            // Update profiles table to remove resume URL
            ...
            // Refresh resume status after a small delay to ensure database updates are complete
            setTimeout(() => {
                loadResumeStatus();
            }, 500);
